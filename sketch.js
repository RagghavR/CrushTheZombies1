...
function setup() {
  ...
  leftWall = new Base(200, height / 2 + 50, 200, 100, "#8d6e63", true);
  rightWall = new Base(width - 200, height / 2 + 50, 200, 100, "#8d6e63", true);
  ...
  jointPoint = new Base(width - 250, height / 2 + 10, 40, 20, "#8d6e63", true);
